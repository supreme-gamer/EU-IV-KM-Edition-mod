...
NGame = {
	...
	GREAT_POWER_FRENZY_START = "9000.1.1",	-- Latest date for the start of the Great Power Frenzy (struggle).
...
NDiplomacy = {
	...
	MAX_PEACE_TREATY_COST = 250,					-- in diplo power
	...
	IMPERIAL_AUTHORITY_FROM_PRINCES = 0.15,			-- Scales to threshold
	...
	CELESTIAL_EMPIRE_REFORM_COST = 75,				-- Mandate cost of enacting a new reform for the Emperor of China.
	...
	PEACE_COST_BECOME_VASSAL = 0.5,					-- Vassalize a country (scales by province wealth)
	...
	PEACE_COST_TRADE_POWER = 20, 					-- Peace cost for demanding trade power
	PEACE_COST_STEER_TRADE = 20,					-- Peace cost for steering trade
	...
	CELESTIAL_EMPIRE_DEFAULT_INFLUENCE = 10,		-- Starting value for Mandate value of a new Chinese Emperor
	...
	CELESTIAL_EMPIRE_MANDATE_PER_STABILITY = 0.12,	-- Yearly change of Mandate for each point of positive stability
	CELESTIAL_EMPIRE_MANDATE_PER_STATE_WITH_PROSPERITY = 0.05,	-- Yearly change of Mandate for each State with prosperity.
	...
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_NONTRIBUTARY_DEV = -2.5,	-- Yearly change of Mandate for each hundred development of neighbouring states that are not the Emperor's tributaries
	...
	GREAT_POWER_SUBJECT_CONTRIBUTION = 1.0,			-- Share of subjects' development that will count towards overlord's Great Power score.
	...
	TRIBUTE_MAX_MONARCH_POWER = 50.0,				-- Tributary State: Max Adm/Dip/Mil per Tributary
	TRIBUTE_BASE_MANPOWER = 0.3,					-- Tributary State: Part of yearly manpower given in tribute
...
NCountry = {
	...
	ADVISOR_COST_INCREASE_PER_YEAR = 0.001,			-- yearly increase in price in percent,
	...
	PROMOTE_COST_MONTHS_ADVISOR_SALARY = 30.0,		-- Promote advisor cost in monthly salaries
	...
	LEGITIMACY_DYNASTY_CHANGE = 30,					-- Legitimacy a new dynasty starts out with
	...
	POWER_MAX = 3000,								-- how much power can be stored at maximum.
	...
	MERCHANT_REPUBLIC_SIZE_LIMIT = 100,

	IDEA_TO_TECH = -0.01,			-- percentage on tech reduction per idea.
	TECH_TIME_COST = 0.3,			-- tech grow with 20% cost over time.
	TECH_AHEAD_OF_TIME = 0.1,		-- per year ahead.


	PS_BUY_IDEA = 400,
	PS_BUY_NATIVE_ADVANCEMENT = 100,
	...
	PS_STRENGTHEN_GOVERNMENT = 25,
	PS_BOOST_MILITARIZATION = 10,
	...
	MONTHS_TO_CHANGE_CULTURE = 3,					-- How many months it will take to change culture in a province, per development.
...
NEconomy = {
	...
	GOLD_MINE_SIZE = 50,							-- Base income from gold mines
	GOLD_MINE_DEPLETION_THRESHOLD = 99,				-- Gold mines above production level or above can be depleted
	GOLD_MINE_DEPLETION_CHANCE = 0.0,					-- Chance of gold mine being depleted (yearly, per production above threshold)
	GOLD_MINE_SIZE_PRIMITIVES = 25,					-- Gold income for very slow techgroups
	...
	AUTONOMY_CHANGE_DURATION = 3600,			-- about 10 years
	...
	LIGHT_SHIP_MAINT_FACTOR = 0.1,					-- _EDEF_LIGHT_SHIP_MAINT_FACTOR_
	GALLEY_MAINT_FACTOR = 0.1,						-- _EDEF_GALLEY_MAINT_FACTOR_
	TRANSPORT_MAINT_FACTOR = 0.1,					-- _EDEF_TRANSPORT_MAINT_FACTOR_
...
NMilitary = {
	...
	EXPLORER_LEADER_POWER = 1.2,					-- Used for conquistadors & explorers (affects total pips)
	...
	SIEGE_WIN = 20,
	UNLOAD_COST_FRIENDLY = 7,						-- cost to unload to friendly territory
	UNLOAD_COST_ENEMY = 14,							-- cost to hostile.
	...
	HEAVY_SHIP_SAILORS_COST = 300,					-- 1 = 1 men in cost.
	LIGHT_SHIP_SAILORS_COST = 120,					-- 1 = 1 men in cost.
	GALLEY_SHIP_SAILORS_COST = 80,					-- 1 = 1 men in cost.
	TRANSPORT_SHIP_SAILORS_COST = 160,				-- 1 = 1 men in cost.
	...
	CAVALRY_SPEED = 1.25, 							-- _MDEF_CAVALRY_SPEED = 10,
	ARTILLERY_SPEED = 0.8, 							-- _MDEF_ARTILLERY_SPEED = 10,
	...
	TRANSPORT_COST = 15,							-- _MDEF_TRANSPORT_COST = 10,
	...
	MERCENARY_SUPPORT_LIMIT_BASE = 10,				-- Base (and thus minimum) value for mercenary support limit.
	...
	LEADER_MIN_PIPS = 5,								-- Min general/admiral pips (total)
...
NAI = {
	...
	MIN_CAV_PERCENTAGE = 10, --AI will always try to have at least this many % of their army as cav, regardless of time in the game.
	...
	DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 40, --AI scoring for guarantee action is increased by this if a nation blocks a powerbalance threat.
	...
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_PLAYER = 80, --AI willingness to send gifts to human nations fighting power balance threat is modulated by this.
	DIPLOMATIC_ACTION_SUBSIDIES_POWERBALANCE_FACTOR = 60, --AI scoring to give subsidies to nations blocking/fighting power balance threat.
	...
	DIPLOMATIC_ACTION_INFLUENCE_NATION_BASE_FACTOR = 10, -- AI base scoring for Influence Nation (needs to be ally or block rival/power balance threat to even apply).
	...
	ARTILLERY_FRACTION = 0.30, 	-- Ratio of artillery to infantry AI will build
	FORCE_COMPOSITION_CHANGE_TECH_LEVEL = 11, -- Tech level at which AI will double its artillery fraction
	TRANSPORT_FRACTION = 0.4, -- Max fraction of naval forcelimit that should be transports
	INCOME_SAVINGS_FRACTION = 0.3, -- AI will reserve this amount of their surplus for long-term savings
	OVER_FORCELIMIT_AVOIDANCE_FACTOR = 40, -- The higher this number is, the less willing the AI will be to exceed forcelimits
	...
	MAX_SAVINGS = 150, -- AI will keep a maximum of this * their monthly income in long-term savings
	...
	ARMY_BUDGET_FRACTION = 1.2, -- AI will spend a maximum of this fraction of monthly income on army maintenance (based off wartime costs)
	NAVY_BUDGET_FRACTION = 0.6, -- AI will spend a maximum of this fraction of monthly income on navy maintenance (based off wartime costs)
	FORT_BUDGET_FRACTION = 0.9, -- AI will spend a maximum of this fraction of monthly income on forts
	...
	CONQUEST_INTEREST_DISTANCE = 110, -- Beyond this range, AI is less interested in conquest of provinces
	...
	DEVELOPMENT_CAP_MULT = 1.65,

	PEACE_BASE_RELUCTANCE = 3, -- AI base stubbornness to refuse peace (always applied)
	...
	PEACE_WAR_DIRECTION_FACTOR = 0.6, -- AI willingness to peace based on who's making gains in the war
	PEACE_WAR_DIRECTION_WINNING_MULT = 6.0, -- Multiplies AI emphasis on war direction if it's the one making gains
	PEACE_FORCE_BALANCE_FACTOR = 0.25, -- AI willingness to peace based on strength estimation of both sides
	...
	PEACE_MILITARY_STRENGTH_FACTOR = 20, -- AI unwillingness to peace based on manpower & forcelimits
	PEACE_ALLY_BASE_RELUCTANCE_MULT = 2.5, -- Multiplies PEACE_BASE_RELUCTANCE for allies in a war
	...
	PEACE_ALLY_REBELS_MULT = 1.25, -- Multiplies PEACE_REBELS_FACTOR for allies in a war
	PEACE_DESIRE_AI_PREFS_QUICK_PEACE = 100, -- How much AI wants to peace out when player enabled AI setting "Seek Quick Peace"
	PEACE_CALL_FOR_PEACE_FACTOR = 25,	-- How much AI wants peace based on having call for peace
	...
	PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.9,
	PEACE_TERMS_TRANSFER_VASSALS_BASE_MULT = 0.8,
	...
	PEACE_TERMS_PROVINCE_IMPERIAL_LIBERATION_MULT = 5.0, --AI Emperor's desire for a province is multiplied by this if this is an Imperial Liberation CB war.
	...
	PEACE_TERMS_PROVINCE_CLAIM_MULT = 3.2, -- AI desire for a province is multiplied by this if it has a claim on it
	PEACE_TERMS_PROVINCE_NOT_CULTURE_MULT = 0.9, -- AI desire for a province is multiplied by this if it is not the same culture
	...
	PEACE_TERMS_PROVINCE_REAL_ADJACENT_MULT = 1.1, -- AI desire for a province is increased by this multiplier for each owned adjacent province
	PEACE_TERMS_PROVINCE_NOT_ADJACENT_MULT = 0.35, -- AI desire for a province is multiplied by this if it is not adjacent at all (including vassals and other provinces being taken in peace)
	...
	PEACE_TERMS_RETURN_CORES_VASSAL_MULT = 20.0, -- AI desire for returning core provinces is multiplied by this for their vassals
	...
	DIPLOMATIC_ACTION_IMPROVE_RELATIONS_ALLY_FACTOR = 75, -- AI scoring for improve relations is increased by this if they have an attitude with 'ally' desire
	...
	DIPLOMATIC_ACTION_SUBSIDIES_WAR_WITH_RIVAL_FACTOR = 100, -- AI scoring for giving subsidies to a country that is at war with its rival
	...
	DIPLOMATIC_ACTION_SUBSIDIES_INDEBTED_FACTOR = 50, -- AI scoring for giving subsidies to an ally in heavy debt
	...
	AI_WANT_ACCEPT_CULTURES = 500,							-- How much the AI values having much development in accepted cultures.
	...
	INVADING_BRAVERY = 1.45,									-- If (defender strength) / (invader strength) > INVADING_BRAVERY, the AI won't attempt a naval invasion
	INVADING_MAX_AWAY_RATIO = 1.6,							-- AI will never send more than this ratio to invade (Measured in strength)
	HOME_FLEET_MAX_RATIO = 0.60,							-- Maximum proportion of warships in home fleet.
	...
	MIN_FORCE_LIMIT_SHARE_REGION_ASSIGN = 0.20,					-- AI will only assign armies larger that this to a region
	MAX_ARMIES_NEW_REGION_ASSIGN_ALGORITHM = 50,				-- Max. amount of armies to use in new region assignment algorithm (fall back to old one)
	...
	ASSIMILATION_INTEREST_AMOUNT_FACTOR = 150,					-- Influence on assimilation interest from number of provinces left to conquer
	INVASION_ARMY_LOOKUP_INTERVAL_ON_FAILURE = 14,				-- If AI fails to find an army for an invasion it will try again in this number of days
	...
	ARMY_DISTANCE_SCORE_IMPACT = 0.7,							-- Army <-> province distance impact on province evaluation
	BORDER_DISTANCE_SCORE_IMPACT = 7.0,							-- Border <-> province distance impact on province evaluation
...
NReligion = {
	...
	AUTHORITY_FROM_DEVELOPMENT = 0.1,							-- Multiplied by development (affected by autonomy)
	AUTHORITY_FROM_AUTONOMY = 0.1,							-- Authority loss from granting autonomy
...
NGovernment = {
	...
	IQTA_POLICY_COOLDOWN_YEARS = 10,
	EFFICIENT_FARMING_DUCAT_MULTIPLIER = 2,
	LAND_AQUISITION_MANPOWER_MULTIPLIER = 0.1,
	...
	RECEIVE_SERFS_DEVELOPMENT = 3,
	RECEIVE_SERFS_MODIFIER_ON_RIVAL_DURATION_DAYS = 365,
	...
	LEADER_AS_MONARCH_TRADITION = 60, -- How much tradition leaders will get when generated for
},
